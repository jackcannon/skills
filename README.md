...
| [`auto-rename-chat`](./skills/auto-rename-chat/SKILL.md) | Rename the chat title using formats A/B/C. Use when the title should upgrade or is wrong, or for "rename the chat", "auto-name this chat", /auto-rename-chat. |
